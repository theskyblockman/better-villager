...
execute as @a[scores={cooldownlvl4=1..10},predicate=datameuh:sneak,nbt={Inventory:[{Slot: -106b, tag:{spell:"regeneration"}}]}] run title @s actionbar [{"text": "Temps de recharge : ","color": "green"},{"score":{"name":"@s","objective":"cooldownlvl4"},"color": "red"}]
execute as @a[scores={cooldownlvl4=0},predicate=datameuh:sneak,nbt={Inventory:[{Slot: -106b, tag:{spell:"regeneration"}}]}] run title @s actionbar [{"text": "Temps de recharge : ","color": "green"},{"text": "Prêt","color": "red"}]
